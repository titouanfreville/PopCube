...
COPY $GOCOPYPATH/api /$GOCOPYPATH/api
COPY $GOCOPYPATH/models /$GOCOPYPATH/models
COPY $GOCOPYPATH/utils /$GOCOPYPATH/utils
COPY $GOCOPYPATH/datastores /$GOCOPYPATH/datastores
