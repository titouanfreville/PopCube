...
CREATE UNIQUE INDEX `nickName_UNIQUE` ON `popcube`.`users` (`nickName` ASC);
...
CREATE INDEX `fk_Message_User_idx` ON `popcube`.`messages` (`idUser` ASC);
